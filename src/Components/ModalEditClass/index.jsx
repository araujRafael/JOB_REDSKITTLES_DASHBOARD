...
// 
import display from "../../images/managerClass/edit-class.svg";
//
...
export function ModalEditClass({ content,isOpen, onClose, onEdit ,...rest}) {
  // Hooks
  const {
    handleSubmit,
    register,
  ...
  // Effects
  useEffect(()=>{
    setValue('nameClass',content.nameClass)
    setValue('tutor',content.tutor)
    setValue('tutorRegister',content.tutorRegister)
    setValue('subject',content.subject)
    setValue('grade',content.grade)
    setValue('countStudents',content.countStudents)
    setValue('limitStudents',content.limitStudents)
  },[content,setValue])
        ...
        <FormContainer>
          <WrapperForm>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="wrap-input">
                <label>Count of Studants</label>
                <input
                  type="number"
                  placeholder="Count of studants in room"
                  name="countStudents"
              ...
              <div className="wrap-input">
                <label>Limit of Studants</label>
                <input
                  type="number"
                  placeholder="Limit of Studants in room"
                  name="limitStudents"
            ...
            <button onClick={() => onClose(!isOpen)}>Cancelar</button>
          </WrapperForm>
        </FormContainer>
      </WrapperModal>
    </Modal>
