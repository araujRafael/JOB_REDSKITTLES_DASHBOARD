...
import { StudantsPerformaceNotifyContainer } from "./styled.js";
...
export function StudantsPerformaceNotify() {
  // Context
  ...
  return (
    <StudantsPerformaceNotifyContainer>
      <span>Studant Performace</span>
